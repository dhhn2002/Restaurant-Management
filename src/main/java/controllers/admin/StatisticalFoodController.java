...
public class StatisticalFoodController {
    ...
    public void render() {
        ...
        try {
            ...
            ArrayList<Statistical.ProductIncome> list = statisticalDao.getQuantityItemByCategory(
                    new Timestamp(startDate.getTime()), new Timestamp(endDate.getTime()), idCategoryFood);
