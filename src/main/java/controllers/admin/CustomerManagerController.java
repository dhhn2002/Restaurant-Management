...
//        popupController.add(this, new CustomerPopupView());
    ...
    public void actionDelete() {
        ...
        try {
            if (JOptionPane.showConfirmDialog(null, "Xác nhận xóa?", 
                    "Xóa khách hàng", ERROR_MESSAGE) != YES_OPTION) {
                return;
            }
    ...
    public void actionEdit() {
        try {
            ...
            if (selectedId < 0) {
                throw new Exception("Chọn khách hàng cần sửa");
            } else {
...
//                popupController.edit(this, new CustomerPopupView(), c);
    ...
    public void actionSearch() {
        try {
            ArrayList<Customer> customers = customerDao.searchByKey(
                    view.getCboSearchField().getSelectedItem().toString(),
