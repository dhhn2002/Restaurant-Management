...
public class LoginView extends javax.swing.JFrame {
    ...
    public void showError(String message) {
        ErrorPopup.show(new Exception(message)); //Vui lòng nhập đầy đủ thông tin/ Mật khẩu sai
    }
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new java.awt.Color(118, 61, 2));
        ...
        btnLogin.setBackground(new java.awt.Color(118, 61, 2));
